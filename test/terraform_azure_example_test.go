...
func TestTerraformAzureExample(t *testing.T) {
	...
	/*
		aws.AddTagsToResource(t, awsRegion, resourceGroupID, map[string]string{"testing": "testing-tag-value"})

		// Look up the tags for the given Instance ID
		instanceTags := aws.GetTagsForEc2Instance(t, awsRegion, resourceGroupID)
